							...
							<div class="col-lg-6">
								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										<form class="form-horizontal form-validate-jquery" id="calLanding">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<select name="sudut" id="sudut" class="form-control minimumrunway">
...
<script type="text/javascript">
	...
	$("#calLanding").on('submit', function(e) {
		e.preventDefault();
		...
		var kecepatan = (ketinggian / waktu) * Math.sin(Math.radians(sudut));
		$("#result").val(kecepatan);
	});
