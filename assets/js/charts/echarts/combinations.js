...
$(function () {
    ...
    require(
        ...
        function (ec, limitless) {
			...
			var line_bar_2 = ec.init(document.getElementById('line_bar_2'), limitless);
			var line_bar_followers = ec.init(document.getElementById('line_bar_followers'), limitless);
            ...
            line_bar_options = {
                ...
                // Add legend
                legend: {
                    data: ['Photos','Videos','Photos Growth','Videos Growth']
                },
                ...
                series: [
                    ...
                    },
					{
                        ...
                        type: 'line',
                        yAxisIndex: 1,
                        data: [3.0, 2.2, 2.3, 6.5, 7.3, 10.2, 22.3, 23.4, 26.0, 17.5, 12.6, 7.2]
                    }
                ]
            };
			
			line_bar_options_followers = {
                ...
                // Add legend
                legend: {
                    data: ['Likes','Comments','Likes Growth','Comments Growth']
                },
			...
			line_bar_options_2 = {
                ...
                // Add legend
                legend: {
                    data: ['Avg. Engagement rate','Growth']
                },
			...
			line_bar_2.setOption(line_bar_options_2);
			line_bar_followers.setOption(line_bar_options_followers);
