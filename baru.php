									...
									<div class="panel-body">
										<form class="form-horizontal form-validate-jquery" id="calDistance">	
											<fieldset class="content-group">		                        
												...
												<div class="form-group">
						                        	<label class="control-label col-lg-2">Actual Landing Distance</label>
													<div class="col-lg-8">
							                            <input type="number" name="minimumrunway" id="minimumrunway" class="form-control minimumrunway">
						                        ...
						                        <div class="form-group">
						                        	<label class="control-label col-lg-2">Minimum Runway</label>
													<div class="col-lg-8">
						                        ...
						                        <div class="text-right">
													<button type="submit" class="btn btn-primary btn-ketinggian btn-waktu">Submit <i class="icon-arrow-right14 position-right"></i></button>
												</div>
											</fieldset>
										</form>
									</div>
